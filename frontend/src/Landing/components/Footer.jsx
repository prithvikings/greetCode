...
const FooterLink = ({ href, children }) => (
  <li>
    <a 
      href={href} 
      className="text-zinc-500 hover:text-white transition-colors duration-200 text-sm font-inter flex items-center gap-1 group"
    >
      {children}
...
const SocialIcon = ({ icon: Icon, href }) => (
  <a 
    href={href}
    className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:border-zinc-700 hover:bg-zinc-800 transition-all duration-200"
  >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-12 md:gap-8 mb-24">
          ...
          <div className="col-span-2 md:col-span-4 space-y-6">
            <h3 className="text-2xl font-poppins font-medium text-white tracking-tight">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
             <h4 className="text-zinc-100 font-medium font-poppins">Product</h4>
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
             <h4 className="text-zinc-100 font-medium font-poppins">Resources</h4>
             <ul className="space-y-4">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
             <h4 className="text-zinc-100 font-medium font-poppins">Company</h4>
             <ul className="space-y-4">
           ...
           <div className="col-span-2 md:col-span-2 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800">
                  ...
                  <span className="text-xs font-medium text-zinc-400 font-mono">All Systems Normal</span>
              </div>
           </div>
        </div>
        ...
        <div className="border-t border-zinc-900 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-1 text-zinc-600 text-sm font-inter">
                <span>Made with</span>
